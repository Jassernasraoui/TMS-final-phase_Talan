table 73550 "Tour Execution Tracking"
{
    ...
    fields
    {
        ...
        field(15; "Quantity Delivered"; Decimal)
        {
            Caption = 'Quantité Livrée';
            DataClassification = CustomerContent;
        ...
        field(18; "Return Reason Code"; Code[20])
        {
        ...
        {
            Caption = 'Code Unité de Mesure';
            DataClassification = CustomerContent;
            TableRelation = "Unit of Measure".Code;
            Editable = false;
        }
        field(22; "Delivery Address"; Text[100])
        {
    ...
    local procedure CalculateQuantityReturned()
    begin
        if "Planned Quantity" <> 0 then begin
            if "Quantity Delivered" > "Planned Quantity" then
                "Quantity Delivered" := "Planned Quantity";

            if "Quantity Delivered" < 0 then
                "Quantity Delivered" := 0;

            "Quantity Returned" := "Planned Quantity" - "Quantity Delivered";
        end;
    end;
}