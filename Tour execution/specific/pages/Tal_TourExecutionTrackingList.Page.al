page 73552 "Tour Execution Tracking List"
{
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Quantité prévue pour la livraison.';
                    Visible = true;
                }
                field("Delivered Quantity"; rec."Quantity Delivered")
                {
                    ApplicationArea = All;
                    ToolTip = 'Quantité livrée pour cette tournée.';
                    Visible = true;
                }
                field("Returned Quantity"; rec."Quantity returned")
                {
                    ApplicationArea = All;
                    ToolTip = 'Quantité retournée pour cette tournée.';
                    Visible = true;
                }
            }
        }
